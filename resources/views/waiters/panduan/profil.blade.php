...
<div class="main-content">
  <section class="section">
      ...
      <div class="section-body">
            ...
            <img src="../assets/img/profilwai.png" alt="jelovaCafe" width="800px" height="200px">
            <br><br><br><br>
            <h6>2. Tekan "Choose File" jika ingin mengupload foto profil akun. Selanjutnya klik "Unggah Foto"</h6>
            <img src="../assets/img/profilwai2.png" alt="jelovaCafe" width="800px" height="320px">
            <br><br><br><br>
            <h6>3. Tekan "Edit profil" apabila ingin mengedit profil</h6>
            <img src="../assets/img/profilwai3.png" alt="jelovaCafe" width="800px" height="320px">
            <br><br><br><br>
            <h6>4. Di Halaman Edit profil, silahkan masukkan data yang ingin diubah.Kemudian klik tombol "Edit"</h6>
            <img src="../assets/img/editwai.png" alt="jelovacafe" width="800px" height="320px"> 
      </div>
      <br>
